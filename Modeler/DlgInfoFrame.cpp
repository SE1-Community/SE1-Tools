...
int CDlgInfoFrame::OnCreate(LPCREATESTRUCT lpCreateStruct) {
  ...
  m_pInfoSheet->SetWindowPos(NULL, 0, 0, rectClient.Width(), rectClient.Height(), SWP_NOZORDER | SWP_NOACTIVATE);
  return 0;
}
...
#define PAGE_SUB_HEIGHT 2
  rectPage = CRect(PAGE_OFFSET_X, PAGE_OFFSET_Y, m_PageWidth - PAGE_SUB_WIDTH, m_PageHeight - PAGE_SUB_HEIGHT);
