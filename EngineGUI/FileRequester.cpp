...
CTFileName CEngineGUI::FileRequester(char *pchrTitle /*="Choose file"*/, char *pchrFilters /*=FILTER_ALL FILTER_END*/,
  ...
  if (pchrRegistry != NULL) {
    strRequestInDirectory
      = AfxGetApp()->GetProfileString(L"Scape", CString(pchrRegistry), CString(_fnmApplicationPath + strDefaultDir));
  }
...
ENGINEGUI_API CTFileName FileRequester(char *pchrTitle, char *pchrFilters, char *pchrRegistry, char *pchrFileSelectedByDefault) {
