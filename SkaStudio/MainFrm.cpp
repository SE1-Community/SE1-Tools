...
static UINT indicators[] = {
  ID_STATUS_BAR_TEXT, ID_SEPARATOR, ID_INDICATOR_CAPS, ID_INDICATOR_NUM, ID_INDICATOR_SCRL,
};
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct) {
  ...
  DWORD dwToolBarStyles
    = TBSTYLE_FLAT | WS_CHILD | WS_VISIBLE | CBRS_SIZE_DYNAMIC | CBRS_TOP | CBRS_TOOLTIPS | CBRS_FLYBY | CBRS_GRIPPER;
  ...
  if (!m_ctrlMIStretch.Create(WS_VISIBLE | WS_BORDER, rcEditStretch, &m_wndNavigationToolBar, ID_MI_STRETCH)) {
  ...
  if (!theApp.m_dlgBarTreeView.Create(
        this, IDD_TREEBAR, CBRS_LEFT | CBRS_TOOLTIPS | CBRS_FLYBY | CBRS_HIDE_INPLACE | CBRS_SIZE_DYNAMIC, ID_VIEW_TREEVIEW)) {
  ...
  LOAD_BAR_STATE("TreeView width", "TreeView height", theApp.m_dlgBarTreeView, STD_TREEVIEW_WIDTH, STD_TREEVIEW_HEIGHT);
