...
int ui_set(MCData *inst, unsigned long vid, void *value) {
  ...
  switch (vid) {
    case ID_FACEFORWARD: inst->mc_iFaceForward = *(int *)value; break;
    case ID_ANIM_ORDER: inst->mc_iAnimOrder = *(int *)value;
...
char *astrFaceForward[] = {"not", "half-faceforward", "full-faceforward", NULL};

char *astrAnimOrder[] = {"Normal", "Reversed", NULL};
...
LWXPanelID get_panel(LWInstance inst) {
  ...
  static LWXPanelHint xhint[]
    = {XpLABEL(0, "SE Exporter master controls"), XpSTRLIST(ID_FACEFORWARD, astrFaceForward),
       XpSTRLIST(ID_ANIM_ORDER, astrAnimOrder), XpBUTNOTIFY(ID_EXPORTMESH, Click_ExportMesh),
       XpBUTNOTIFY(ID_EXPORTSKELETON, Click_ExportSkeleton), XpBUTNOTIFY(ID_EXPORTANIM, Click_ExportAnim),
       XpBUTNOTIFY(ID_EXPORTBONES, Click_ExportBones), XpBUTNOTIFY(ID_EXPORTSECANIM, Click_ExportSecAnim),
  ...
  if (panel = _xpanf->create(LWXP_VIEW, xctl)) {
    ...
    _xpanf->describe(panel, xdata, (void *(__cdecl *)(void *, unsigned long))ui_get,
...
XCALL_(int) Interface_Master(long version, GlobalFunc *global, LWInterface *local, void *serverData) {
  ...
  if (!_colorpick || !_lwupdate || !_xpanf)
    return AFUNC_BADGLOBAL;
...
int msgbox_modeler(LWXPanelFuncs *xpanf, const char *msg) {
  ...
  LWXPanelDataDesc cdata[] = {{
                              ...
                              {0}};
  LWXPanelHint hint[] = {XpLABEL(0, "SE Mesh Exporter master controls"), XpLABEL(ID_MSG, msg), XpEND};
...
int get_user_modeler(LWXPanelFuncs *xpanf) {
  ...
  LWXPanelDataDesc cdata[] = {{
                              ...
                              {0}};
  LWXPanelHint hint[] = {XpLABEL(0, "SE Mesh Exporter master controls"), XpSTRLIST(ID_FACEFORWARD, astrFaceForward), XpEND};
