...
void CCtrlEditFlags::SetPrevEditableBank(void) {
  if (m_iCurrentBank == 0 && m_ulEditable & 0xff000000)
    m_iCurrentBank = 3;
  if (m_iCurrentBank == 1 && m_ulEditable & 0x000000ff)
    m_iCurrentBank = 0;
  if (m_iCurrentBank == 2 && m_ulEditable & 0x0000ff00)
    m_iCurrentBank = 1;
  if (m_iCurrentBank == 3 && m_ulEditable & 0x00ff0000)
    m_iCurrentBank = 2;
}

void CCtrlEditFlags::SetNextEditableBank(void) {
  INDEX iOldCurrentBank = m_iCurrentBank;
  if (m_iCurrentBank == 0 && m_ulEditable & 0x0000ff00)
    m_iCurrentBank = 1;
  if (m_iCurrentBank == 1 && m_ulEditable & 0x00ff0000)
    m_iCurrentBank = 2;
  if (m_iCurrentBank == 2 && m_ulEditable & 0xff000000)
    m_iCurrentBank = 3;
  if (m_iCurrentBank == 3 && m_ulEditable & 0x000000ff)
    m_iCurrentBank = 0;
...
void CCtrlEditFlags::SetFirstEditableBank(void) {
  m_iCurrentBank = 0;
  if (m_ulEditable & 0x000000ff)
    m_iCurrentBank = 0;
  else if (m_ulEditable & 0x0000ff00)
    m_iCurrentBank = 1;
  else if (m_ulEditable & 0x00ff0000)
    m_iCurrentBank = 2;
  else if (m_ulEditable & 0xff000000)
    m_iCurrentBank = 3;
}
