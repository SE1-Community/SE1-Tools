    ...
    switch (theApp.m_vfpCurrent.vfp_ptPrimitiveType) {
      ...
      case PT_TERRAIN: {
        ...
        m_strDisplacePicture
          = theApp.m_vfpCurrent.vfp_fnDisplacement.FileName() + theApp.m_vfpCurrent.vfp_fnDisplacement.FileExt();
...
#define PRIMITIVE_CHANGED_DELTA 0.01f
    ...
    if (((theApp.m_vfpCurrent.vfp_ptPrimitiveType == PT_CONUS) || (theApp.m_vfpCurrent.vfp_ptPrimitiveType == PT_TORUS))
        && (theApp.m_vfpCurrent.vfp_avVerticesOnBaseOfPrimitive.Count() != m_fEdit3) && ((INDEX)(m_fEdit3) > 0)) {
...
BOOL CDlgPgPrimitive::OnInitDialog() {
  ...
  if (!IsWindow(m_comboPrimitiveHistory.m_hWnd))
    return TRUE;
  ...
  FOREACHINLIST(CPrimitiveInHistoryBuffer, pihb_lnNode, theApp.m_lhPrimitiveHistory, itPrim) {
    ...
    switch (itPrim->pihb_vfpPrimitive.vfp_ptPrimitiveType) {
      ...
      case PT_TORUS: {
        strDescription.PrintF(
          "%d vtx, Size(%g,%g) Radius(%g) Slices(%d,%d)", itPrim->pihb_vfpPrimitive.vfp_avVerticesOnBaseOfPrimitive.Count(),
          itPrim->pihb_vfpPrimitive.vfp_fXMax - itPrim->pihb_vfpPrimitive.vfp_fXMin,
          itPrim->pihb_vfpPrimitive.vfp_fZMax - itPrim->pihb_vfpPrimitive.vfp_fZMin, itPrim->pihb_vfpPrimitive.vfp_fRadius,
          itPrim->pihb_vfpPrimitive.vfp_iSlicesIn360, itPrim->pihb_vfpPrimitive.vfp_iNoOfSlices);
        break;
      }
      case PT_STAIRCASES: {
        if (itPrim->pihb_vfpPrimitive.vfp_bLinearStaircases) {
          strDescription.PrintF("%d stairs, Size(%g,%g,%g)", itPrim->pihb_vfpPrimitive.vfp_iNoOfSlices,
                                itPrim->pihb_vfpPrimitive.vfp_fXMax - itPrim->pihb_vfpPrimitive.vfp_fXMin,
                                itPrim->pihb_vfpPrimitive.vfp_fZMax - itPrim->pihb_vfpPrimitive.vfp_fZMin,
                                itPrim->pihb_vfpPrimitive.vfp_fYMax - itPrim->pihb_vfpPrimitive.vfp_fYMin);
        } else {
          strDescription.PrintF("Radius(%g), %d Slices %d Stairs Size(%g,%g)", itPrim->pihb_vfpPrimitive.vfp_fRadius,
                                itPrim->pihb_vfpPrimitive.vfp_iSlicesIn360, itPrim->pihb_vfpPrimitive.vfp_iNoOfSlices,
                                itPrim->pihb_vfpPrimitive.vfp_fXMax - itPrim->pihb_vfpPrimitive.vfp_fXMin,
                                itPrim->pihb_vfpPrimitive.vfp_fYMax - itPrim->pihb_vfpPrimitive.vfp_fYMin);
        }
      ...
      case PT_SPHERE: {
        strDescription.PrintF("Size(%g,%g,%g) %d meridians %d parallels",
                              ...
                              itPrim->pihb_vfpPrimitive.vfp_fZMax - itPrim->pihb_vfpPrimitive.vfp_fZMin,
                              itPrim->pihb_vfpPrimitive.vfp_fYMax - itPrim->pihb_vfpPrimitive.vfp_fYMin,
                              itPrim->pihb_vfpPrimitive.vfp_iMeridians, itPrim->pihb_vfpPrimitive.vfp_iParalels);
        break;
      }
      case PT_TERRAIN: {
        strDescription.PrintF("Size(%g,%g,%g) Slices(%d,%d)",
                              ...
                              itPrim->pihb_vfpPrimitive.vfp_fZMax - itPrim->pihb_vfpPrimitive.vfp_fZMin,
                              itPrim->pihb_vfpPrimitive.vfp_fYMax - itPrim->pihb_vfpPrimitive.vfp_fYMin,
                              itPrim->pihb_vfpPrimitive.vfp_iSlicesPerWidth, itPrim->pihb_vfpPrimitive.vfp_iSlicesPerHeight);
    ...
    strPosition.PrintF(", Pos(%g,%g,%g), Ang(%g,%g,%g)", itPrim->pihb_vfpPrimitive.vfp_plPrimitive.pl_PositionVector(1),
    ...
    INDEX iAddedAs = m_comboPrimitiveHistory.AddString(CString(strNo + strDescription + strPosition + strTriangularisation));
...
void CDlgPgPrimitive::OnDisplaceBrowse() {
  CTFileName fnDisplace = _EngineGUI.FileRequester(
    "Choose picture for displacement", FILTER_TGA FILTER_PCX FILTER_ALL FILTER_END, "Displacement pictures directory",
    "Textures\\", theApp.m_vfpCurrent.vfp_fnDisplacement.FileName() + theApp.m_vfpCurrent.vfp_fnDisplacement.FileExt());
  if (fnDisplace == "")
    return;
...
void CDlgPgPrimitive::OnLoadPrimitiveSettings() {
  ...
  _fnPrimitiveSettingsSavedAs = _EngineGUI.FileRequester("Choose file to load primitive settings",
                                                         "Primitive settings (*.prm)\0*.prm\0" FILTER_ALL FILTER_END,
                                                         "Primitive settings", "", "", NULL, TRUE);
