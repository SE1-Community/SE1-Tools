...
BOOL CWndDisplayTexture::Initialize(PIX pixX, PIX pixY, CTextureData* ptd, CTString strText1 /*""*/, CTString strText2 /*""*/,
                                    BOOL bDown /*=FALSE*/) {
  m_ptd = ptd;
  m_strText1 = strText1;
  m_strText2 = strText2;
  ...
  if (IsWindow(m_hWnd)) {
    ...
    BOOL bResult = CreateEx(WS_EX_TOOLWINDOW, NULL, L"Display texture", WS_CHILD | WS_POPUP | WS_VISIBLE, rectWindow.left,
