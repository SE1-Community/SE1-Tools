...
class CMasterViewer {
  ...
  inline CPlacement3D GetViewerPlacement(void) const {
    return mv_plViewer;
  };
...
class CSlaveViewer {
  ...
  public:
  // default constructor
  CSlaveViewer(const CMasterViewer &mvMaster, enum ProjectionType ptProjectionType, const CPlacement3D &plGrid,
  ...
  // get target distance
  inline FLOAT GetTargetDistance(void) const {
    return sv_fTargetDistance;
  };
  ...
  void TranslatePlacement_OtherSystem(CPlacement3D &plToTranslate, CPlacement3D &plOtherSystem, PIX pixDI, PIX pixDJ, PIX pixDK);
  ...
  void TranslatePlacement_OwnSystem(CPlacement3D &plToTranslate, PIX pixDI, PIX pixDJ, PIX pixDK);
  // rotate a placement in viewer's system
  void RotatePlacement_HPB(CPlacement3D &plToRotate, PIX pixDI, PIX pixDJ, PIX pixDK);
  // rotate a placement in viewer's system
  void RotatePlacement_TrackBall(CPlacement3D &plToRotate, PIX pixDI, PIX pixDJ, PIX pixDK);
