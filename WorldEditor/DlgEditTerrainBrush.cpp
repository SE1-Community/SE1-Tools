...
CDlgEditTerrainBrush::CDlgEditTerrainBrush(CWnd* pParent /*=NULL*/) : CDialog(CDlgEditTerrainBrush::IDD, pParent) {
...
void CDlgEditTerrainBrush::OnImportTerrainBrush() {
  CTFileName fnBrush = _EngineGUI.FileRequester("Choose picture for brush", FILTER_TGA FILTER_PCX FILTER_ALL FILTER_END,
  ...
  if ((ii.ii_Width == 1 << ((int)Log2((FLOAT)ii.ii_Width))) && (ii.ii_Height == 1 << ((int)Log2((FLOAT)ii.ii_Height)))) {
