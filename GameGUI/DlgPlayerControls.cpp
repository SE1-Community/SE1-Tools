...
void CDlgPlayerControls::FillActionsList(void) {
  ...
  if (iDefaultSelected != -1) {
    // select wanted item
    m_listButtonActions.SetItemState(iDefaultSelected, LVIS_FOCUSED | LVIS_SELECTED | LVIS_DROPHILITED,
...
void CDlgPlayerControls::FillAxisList(void) {
  ...
  // try to select same item that was selected before refresh list
  if (iDefaultSelected != -1) {
    m_listAxisActions.SetItemState(iDefaultSelected, LVIS_FOCUSED | LVIS_SELECTED | LVIS_DROPHILITED,
                                   LVIS_FOCUSED | LVIS_SELECTED | LVIS_DROPHILITED);
...
void CDlgPlayerControls::ActivatePressKey(char *strFirstOrSecond) {
  ...
  if (m_iSelectedAction != -1) {
    m_listButtonActions.SetItemState(m_iSelectedAction, LVIS_FOCUSED | LVIS_SELECTED | LVIS_DROPHILITED,
                                     LVIS_FOCUSED | LVIS_SELECTED | LVIS_DROPHILITED);
